			...
			<div class="col-sm-10 col-xs-12">
				...
				<div class="row">
					<div class="col-sm-4 col-xs-12 homepage-point">
						<a href="<?= $link1 ?>"><img src='<?=get_template_directory_uri()?>/images/homeicon1.svg' alt='<?=__('Shop Now')?>'><h2><?=__('Shop Now')?></h2></a>
						<p><?=__('Shop from our collection of GMP-certified medical cannabis')?></p>
					</div>
					<div class="col-sm-4 col-xs-12 homepage-point">
						<a href="<?= $link2 ?>"><img src='<?=get_template_directory_uri()?>/images/homeicon2.svg' alt='<?=__('Register')?>'><h2><?=__('Register')?></h2></a>
						<p><?=__('Become a Tilray customer')?></p>
					</div>
					<div class="col-sm-4 col-xs-12 homepage-point">
						<a href="<?= $link3 ?>"><img src='<?=get_template_directory_uri()?>/images/homeicon3.svg' alt='<?=__('Questions?')?>'><h2><?=__('Questions?')?></h2></a>
