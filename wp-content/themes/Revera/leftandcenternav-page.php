	...
	<div class="row">
		...
		<script>
			...
			for(var i = 0; i < allPanes.length; i++)
			{
				...
				jQuery(allPanes[i]).append("<p class='back-to-top'><a href='#' onclick='jQuery(\"html, body\").animate({scrollTop:0});'><i class='icon-up-big' aria-hidden='true'></i><?php _e('Back to Top')?></a></p>");
